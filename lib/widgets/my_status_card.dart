...
class _MyStatusCardState extends State<MyStatusCard> {
  ...
  Widget build(BuildContext context) {
    final eligible = _lastDonated != null &&
        BloodEligibility.isEligible(_lastDonated!);
    final progress = _lastDonated == null
        ? 0.0
        : BloodEligibility.progress(_lastDonated!);
    final progressColor =
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: Text(
                          BloodEligibility.statusCopy(_lastDonated),
                          style: TextStyle(
                            fontSize: 13,
