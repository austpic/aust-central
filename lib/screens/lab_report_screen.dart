...
class _LabReportScreenState extends State<LabReportScreen> {
                  ...
                  Row(
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: const Color(0xFFBEEDDC).withOpacity(0.5),
                          borderRadius: BorderRadius.circular(10),
                        ),
                        child: Icon(icon, color: const Color(0xFF407362), size: 22),
                      ),
  ...
  Widget build(BuildContext context) {
    final Color primaryColor = const Color(0xFF407362);
    final Color secondaryColor = const Color(0xFFBEEDDC);
