...
class _BookPostPageState extends State<_BookPostForm> {
  ...
  /// Upload any chosen photos, then create the listing.
  ///
  /// Images are uploaded first so the listing is only created once its
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  // Department and semester are required by the API and were
                  // missing from this form entirely — a listing cannot be
                  // filtered or browsed without them.
