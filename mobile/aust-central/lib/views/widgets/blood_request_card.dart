...
/// Maps request urgency onto colours.
///
/// Presentation, not domain — it imports Material and the theme, so it's a
/// view concern and lives with the widgets that use it. It previously sat in
/// utils/ alongside domain rules, which blurred the two.
